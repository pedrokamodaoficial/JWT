...
namespace JSW___Nyous.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        // Defini uma variável para percorrer nossos métodos com as configurações obtidas no appsettings.json
        private IConfiguration _config;

        // Defini um método construtor para poder passar essas configs
        ...
        new Claim(JwtRegisteredClaimNames.Jti, Guid.NewGuid().ToString()),
                // Salva nas claims o texto do tipo de usuário (Administrador, Padrão)
